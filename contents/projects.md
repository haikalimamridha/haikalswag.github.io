...
- **Niikah**
  - Description: Niikah is a web-based digital wedding invitation platform that allows users to create, customize, manage, and share wedding invitations with responsive HTML templates.
...
- **Wumpus World Analytics**
  ...
  - Link: https://github.com/haikalimamridha/wumpus
  - Tech: Python

- **Hypernova Escape**
  - Description: A fast-paced 3D arcade space runner game built using C++ and OpenGL / GLUT. Navigate through dangerous asteroid fields, blast obstacles away, and control your camera dynamically to survive the cosmic hypernova!
  - Link: https://github.com/haikalimamridha/Hypernova-Escape
  - Tech: C++, Cmake 
